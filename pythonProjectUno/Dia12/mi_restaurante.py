...
# lista de productos
lista_comidas = ['pollo', 'cordero','salmon','burguer','burguer2','pizza','pizza2','salchipapas']
lista_bebidas = ['agua', 'soda','jugo1','jugo2','limonada','limonada2','cerveza','vino']
...
texto_costo_postre = Entry(panel_costos, font=('Dosis', 12, 'bold'),
                           bd=1, width=10, state='readonly', textvariable=var_costo_postre)
...
texto_impuestos = Entry(panel_costos, font=('Dosis', 12, 'bold'),
                           bd=1, width=10, state='readonly', textvariable=var_impuestos)
...
# area de recibo
texto_recibo = Text(panel_recibo, font=('Dosis', 12, 'bold'),
